...
def place_cases_greedy_max_3d(pallet_length, pallet_width, max_stacking_height, case_length, case_width, case_height, pallet_height=150):
    best_positions = []
...
def calculate_pallet_load(max_stacking_height, case_height, pallet_height, max_cases_per_layer, case_net_weight, case_gross_weight, max_pallet_weight):
    ...
    load_gross_weight = total_gross_weight + 25  # Including pallet weight
    ...
    while load_gross_weight > max_pallet_weight and max_layers > 0:
        ...
        total_gross_weight = max_cases_per_load * case_gross_weight
        load_height = pallet_height + (max_layers * case_height)
        load_gross_weight = total_gross_weight + 25
...
#pdf creation code 
def create_pdf_report(pallet_length, pallet_width, positions, case_length, case_width, case_height, df_main, df_summary, df_container_40, df_container_summary_40, df_container_20, df_container_summary_20, df_container_loose_40, df_container_summary_loose_40, df_container_loose_20, df_container_summary_loose_20):
    class PDF(FPDF):
        def header(self):
    ...
    pdf.output("Unilever_International_Pallet_Loading_Report.pdf")
    print("\nPDF report has been created.")

# Taking user input for case dimensions, weights, and maximum stacking height
case_length = float(input("Enter the case length (in): "))
case_width = float(input("Enter the case width (in): "))
case_height = float(input("Enter the case height (in): "))
case_net_weight = float(input("Enter the case net weight (lbs): "))
case_gross_weight = float(input("Enter the case gross weight (lbs): "))
max_stacking_height = float(input("Enter the maximum stacking height (in): "))

# Pallet dimensions
pallet_length = 1200
pallet_width = 1000
pallet_height = 150
max_pallet_weight = 1000
...
container_length_40 = 12032
container_width_40 = 2350
container_height_40 = 2350
container_tare_weight_40 = 3700
container_max_weight_40 = 32000
...
container_length_20 = 5896
container_width_20 = 2350
container_height_20 = 2350
container_tare_weight_20 = 2280
container_max_weight_20 = 30000
...
# Creating DataFrames for display
...
# Generate PDF report
create_pdf_report(pallet_length, pallet_width, positions, case_length, case_width, case_height, df_main, df_summary, df_container_40, df_container_summary_40, df_container_20, df_container_summary_20, df_container_loose_40, df_container_summary_loose_40, df_container_loose_20, df_container_summary_loose_20 )
